...
if __name__=='__main__':
    ...
    parser.add_argument('-o', '--output', type=str, help="Path to a directory where to copy the file 'C80_result_single_phrase.json' that contains per-sample results.", required=False)
    ...
    if args.output:
        ...
        resultsOutputname = os.path.join(output_dir, 'C80_result_single_phrase.json')
