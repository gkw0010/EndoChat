...
#pretrained_path=output/llama_ens5_light_13b_esd/epoch0_c80_endovis_2
#pretrained_type=consolidated
#llama_config="output/llama_ens5_light_13b_esd/epoch0_c80_endovis_2/config.json"
#tokenizer_path="output/llama_ens5_light_13b_esd/epoch0_c80_endovis_2/tokenizer.model"
